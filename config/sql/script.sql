...
(
	...
	CONSTRAINT fk_estado_incidencia FOREIGN KEY (EST_codigo)
	REFERENCES ESTADO (EST_codigo),
	CONSTRAINT fk_categoria_incidencia FOREIGN KEY (CAT_codigo)
	REFERENCES CATEGORIA (CAT_codigo),
	CONSTRAINT fk_area_incidencia FOREIGN KEY (ARE_codigo)
	REFERENCES AREA (ARE_codigo),
...
(
	...
	CONSTRAINT fk_incidencia_recepcion FOREIGN KEY (INC_numero)
	REFERENCES INCIDENCIA (INC_numero),
	CONSTRAINT fk_usuario_recepcion FOREIGN KEY (USU_codigo)
	REFERENCES USUARIO (USU_codigo),
	CONSTRAINT fk_prioridad_recepcion FOREIGN KEY (PRI_codigo)
	REFERENCES PRIORIDAD (PRI_codigo),
	CONSTRAINT fk_impacto_recepcion FOREIGN KEY (IMP_codigo)
	REFERENCES IMPACTO (IMP_codigo)
);
GO
...
EXEC SP_Registrar_Incidencia_Admin '2024-06-07','23:02','No enciende', 'averia','S/D','740899500326',3,2,5,1

select * from INCIDENCIA
SELECT INC_numero, INC_fecha, INC_hora, INC_asunto, INC_descripcion, INC_documento, INC_codigoPatrimonial, 
e.EST_descripcion, c.CAT_nombre, a.ARE_nombre, u.USU_nombre
FROM INCIDENCIA i
...
SELECT 
    INC_numero,
    INC_fecha,
    CONVERT(VARCHAR(5), INC_hora, 108) AS INC_hora,  -- Usar CONVERT para mostrar solo horas y minutos
    INC_asunto,
    INC_descripcion,
    INC_documento,
    INC_codigoPatrimonial,
