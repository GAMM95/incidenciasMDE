...
<body class="bg-green-50 flex items-center justify-center min-h-screen">
  ...
  <aside class="bg-white text-gray-800 w-60 flex flex-col shadow-md overflow-y-auto rounded-lg">
    ...
    <div class="py-4 px-4  border-gray-300">
      <button class="w-full mt-20 mb-2 text-white bg-green-500 text-white rounded-lg hover:bg-green-700  transition-colors font-bold py-2 px-4 rounded shadow-lg hover:shadow-lg shadow-xl">
