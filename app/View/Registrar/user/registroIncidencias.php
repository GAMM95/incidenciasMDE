    ...
    <form id="formIncidencia" action="registro-incidencia.php?action=registrar" method="POST" class="border bg-white shadow-md p-6 w-full text-sm rounded-md">
      ...
      <div class="flex flex-wrap -mx-2">
        <!-- <div class="w-full sm:w-1/2 px-2 mb-2">
          ...
          <input id="area" name="area" class="border border-gray-200 bg-gray-100 p-2 w-full text-sm" readonly>
        </div> -->
        <div class="w-full sm:w-1/2 px-2 mb-2">
          <label for="usuarioDisplay" class="block font-bold mb-1">Área:</label>
          <input type="text" id="usuarioDisplay" name="usuarioDisplay" class="border border-gray-200 bg-gray-100 p-2 w-full text-sm" value="<?php echo $_SESSION['area']; ?>" readonly>
        </div>
      ...
      <!-- TERCERA fila: Categhoria, Código Patrimonial -->
      <div class="flex flex-wrap -mx-2">
        <!-- Categoria -->
