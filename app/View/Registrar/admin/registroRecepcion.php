...
<body>
  ...
  <main class="bg-[#eeeff1] flex-1 p-4 overflow-y-auto">
    ...
    ?>
    <!-- Header -->
    <h1 class="text-xl text-gray-400 mb-2">Incidencias no recepcionadas</h1>
    ...
    <h1 class="text-xl font-bold text-gray-800 mt-4 mb-2">Recepción de incidencia</h1>
    <!-- TODO: Formulario -->
      ...
      <form id="formRecepcion" action="registro-recepcion-admin.php?action=registrar" method="POST">
        ...
        <div class="flex justify-center mx-2 mb-4">
          <div class="flex-1 max-w-[500px] px-2 mb-2 flex items-center">
            ...
            <input disabled type="text" class="w-20 border border-gray-200 bg-gray-100 rounded-md p-2 text-sm text-center" id="INC_codigo_visible" name="INC_codigo_visible">
          </div>
        </div>
