        ...
        <div>
            <div class="relative max-h-[200px] overflow-x-hidden shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500">
                    ...
                    <tbody>
                        <?php
                        require_once './app/Model/RecepcionModel.php'; // Asegúrate de tener el modelo correcto para la recepción
                        ...
                        try {
                            ...
                            foreach ($recepciones as $recepcion) {
                                ...
                                echo "<td class='px-6 py-4'>" . $recepcion['REC_numero'] . "</td>";
                                echo "<td id='incCodigo' class=' hidden px-6 py-4'>" . $recepcion['INC_numero'] . "</td>";
            ...
            <form id="formCierre" action="registro-cierre.php?action=registrar" method="POST">
                ...
                <div class="flex justify-center mx-2 mb-4">
                    <div class="flex-1 max-w-[500px] px-2 mb-2 flex items-center">
                        <label for="REC_codigo_visible" class="block font-bold mb-1 mr-1 text-lime-500">Nro
                            Recepción:</label>
                        <input disabled type="text" class="w-20 border border-gray-200 bg-gray-100 rounded-md p-2 text-sm" id="REC_codigo_visible" name="REC_codigo_visible">
                    </div>
                </div>
                ...
                <div class="flex flex-wrap -mx-2 mb-2">
                    ...
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        <input type="text" id="usuarioDisplay" name="usuarioDisplay" class="border border-gray-200 bg-gray-100 p-2 w-full text-sm" value="<?php echo $_SESSION['usuario']; ?>">
                    </div>
                ...
                <div class="flex flex-wrap -mx-2 mb-4">
                    <div class="w-full md:w-1/3 px-2 mb-4">
                        ...
                        ?>
                        <input type="text" id="hora" name="hora" class="border border-gray-200 bg-gray-100 p-2 w-full text-sm" value="<?php echo $horaActual; ?>" readonly>
                    </div>
                    <div class="w-full hidden md:w-1/3 px-2 mb-4">
                        <label for="incidencia" class="block font-bold mb-1">Inc:</label>
                        <input type="text" id="incidencia" name="incidencia" class="border border-gray-200 bg-gray-100 p-2 w-full text-sm" readonly>
                    </div>
